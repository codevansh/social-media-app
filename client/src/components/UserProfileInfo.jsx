            ...
            <div className='flex flex-col md:flex-row items-start gap-6'>
                ...
                <div className='w-full pt-16 md:pt-0 md:pl-36'>
                    <div className='flex flex-row md:flex-row items-start justify-between'>
                        ...
                        {!profileId &&
                            <button className='flex items-center gap-2 border border-gray-300 hover:bg-gray-50 px-4 py-2 rounded-lg font-medium transition-colors mt-4 md:mt-0 cursor-pointer' onClick={() => setShowEdit(true)}>
                    ...
                    <div className='flex items-center gap-6 mt-6 border-t border-gray-900 pt-4'>
                        <div>
